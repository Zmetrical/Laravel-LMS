...
Route::name('api.')->group(function () {
    ...
    Route::get('/section/data', [User_Management::class, 'get_Sections'])->name('sections.data');
    ...
    Route::prefix('student')->name('student.')->middleware(['web', 'auth:student'])->group(function () {
        ...
        Route::prefix('class/{classId}')->name('class.')->group(function () {
            ...
            Route::get('/lesson/{lessonId}/lecture/{lectureId}/data', [Page_Lecture::class, 'getData'])->name('lecture.data');
        });
