...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item active">Teacher Audit Logs</li>
    </ol>
@endsection
...
<div class="container-fluid">
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-chalkboard-teacher mr-2"></i>Teacher Activity Logs</h3>
...
@section('scripts')
    ...
    <script src="{{ asset('js/audit/teacher_logs.js') }}"></script>
@endsection